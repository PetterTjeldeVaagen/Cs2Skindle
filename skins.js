...
function createSkins(input){
    ...
    skinList.push(new Skin("Aeolian Dark","Rifle","M4A4","Industrial Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Sleet","Rifle","M249","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Earth Mandala","Mid-Tier","Zeus x27","Mil-Spec","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Hellish","Rifle","M4A4","Classified","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Charged Up","Mid-Tier","Zeus x27","Restricted","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Sheet Lightning","Rifle","M4A4","Restricted","The Boreal Collection"))
    ...
    skinList.push(new Skin("VariCamo Grey","Rifle","AK-47","Industrial Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Swamp DDPAT","Mid-Tier","Zeus x27","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Copper Oxide","Pistol","P250","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Raw Ceramic","Rifle","Negev","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Sage Camo","Rifle","M249","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Electric Blue","Mid-Tier","Zeus x27","Industrial Grade","The Ascent Collection"))
    skinList.push(new Skin("Naval Shred Camo","Rifle","M4A4","Industrial Grade","The Ascent Collection"))
    skinList.push(new Skin("Sour Grapes","Rifle","Negev","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Steel Work","Rifle","M4A4","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Full Throttle","Rifle","M4A4","Covert","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Tosai","Mid-Tier","Zeus x27","Restricted","Fever Case"))
    skinList.push(new Skin("PC-GRN","Pistol","USP-S","Mil-Spec","Fever Case"))
    skinList.push(new Skin("Choppa","Rifle","M4A4","Mil-Spec","Fever Case"))
