class Skin {
    constructor(name, weaponClass,gun, rarity, collection) { 
      ...
      switch (this.collection) {
        ...
        if(this.collection.includes("Limited Edition Item")){
            this.collection = "Limited Edition Item";
        }
    }  
}
...
function createSkins(input){
    ...
    skinList.push(new Skin("Byproduct","Rifle","FAMAS","Consumer Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Red Wing","Pistol","P2000","Mil-Spec","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Gum Wall Camo","Mid-Tier","XM1014","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Buzz Kill","Rifle","M4A4","Covert","Operation Wildfire Case"))
    skinList.push(new Skin("Trace Lock","Pistol","Glock-18","Restricted","The Achroma Collection"))
    ...
    skinList.push(new Skin("Eye of Horus","Rifle","M4A4","Covert","The 2021 Train Collection"))
    ...
    skinList.push(new Skin("Midnight Laminate","Rifle","AK-47","Restricted","The Ascent Collection"))
    ...
    skinList.push(new Skin("Wintergreen","Rifle","AK-47","Mil-Spec","The Boreal Collection"))
    ...
    skinList.push(new Skin("Marsh Grass","Mid-Tier","Nova","Consumer Grade","The Radiant Collection"))
    skinList.push(new Skin("Blueprint","Rifle","SCAR-20","Mil-Spec","Spectrum Case"))
    skinList.push(new Skin("Tooth Fairy","Rifle","M4A4","Classified","Operation Hydra Case"))
    skinList.push(new Skin("Cat Fight","Mid-Tier","MAC-10","Restricted","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Vendetta","Rifle","FAMAS","Industrial Grade","The Achroma Collection"))
    skinList.push(new Skin("Button Masher","Mid-Tier","MAC-10","Restricted","Snakebite Case"))
    skinList.push(new Skin("Spider Lily","Rifle","M4A4","Restricted","Falchion Case"))
    skinList.push(new Skin("Wasteland Princess","Mid-Tier","Sawed-Off","Classified","Glove Case"))
    skinList.push(new Skin("Cyber Security","Rifle","M4A4","Classified","Fracture Case"))
    ...
    skinList.push(new Skin("Crimson Batik","Mid-Tier","Sawed-Off","Consumer Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Zinc","Rifle","SCAR-20","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Coral Paisley","Mid-Tier","MP7","Industrial Grade","The Harlequin Collection"))
    skinList.push(new Skin("Honey Paisley","Pistol","CZ75-Auto","Consumer Grade","The Harlequin Collection"))
    skinList.push(new Skin("Control Panel","Rifle","M4A1-S","Classified","The 2018 Nuke Collection"))
    skinList.push(new Skin("Nouveau Rouge","Rifle","AK-47","Classified","The Radiant Collection"))
    ...
    skinList.push(new Skin("Royal Baroque","Pistol","P2000","Mil-Spec","The Ascent Collection"))
    ...
    skinList.push(new Skin("Basket Halftone","Rifle","SG 553","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Neo-Noir","Rifle","M4A4","Covert","Glove Case"))
    ...
    skinList.push(new Skin("Green Energy","Rifle","AWP","Classified","The Boreal Collection"))
    ...
    skinList.push(new Skin("Angel Eyes","Pistol","Dual Berettas","Restricted","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Cobalt Paisley","Mid-Tier","MP9","Mil-Spec","The Ascent Collection"))
    ...
    skinList.push(new Skin("Copper Oxide","Mid-Tier","MAG-7","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Full Throttle","Rifle","M4A4","Covert","Revolution Case"))
    skinList.push(new Skin("Royal Guard","Pistol","USP-S","Restricted","The Ascent Collection"))
    ...
    skinList.push(new Skin("The End","Rifle","AWP","Classified","The Achroma Collection"))
    ...
    skinList.push(new Skin("Breakthrough","Rifle","AK-47","Restricted","The Achroma Collection"))
    skinList.push(new Skin("The Daily Deagle","Pistol","Desert Eagle","Mil-Spec","The Achroma Collection"))
    ...
    skinList.push(new Skin("2A2F","Rifle","FAMAS","Mil-Spec","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Converter","Rifle","M4A4","Mil-Spec","The Nuke Collection"))
    skinList.push(new Skin("Trigger Discipline","Pistol","Desert Eagle","Restricted","Snakebite Case"))
    skinList.push(new Skin("Sleet","Pistol","P250","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Earth Mandala","Pistol","Zeus x27","Mil-Spec","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Sky Mandala","Rifle","Galil AR","Mil-Spec","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Sheet Lightning","Rifle","M4A4","Restricted","Gallery Case"))
    skinList.push(new Skin("Black Nile","Rifle","AWP","Mil-Spec","Anubis Collection Package"))
    skinList.push(new Skin("Marsh","Pistol","P2000","Industrial Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Leafhopper","Pistol","R8 Revolver","Industrial Grade","The Boreal Collection"))
    skinList.push(new Skin("Smoking Kills","Mid-Tier","MP7","Classified","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Tiger Tear","Rifle","SSG 08","Industrial Grade","The Boreal Collection"))
    skinList.push(new Skin("Acid Hex","Mid-Tier","MAC-10","Industrial Grade","The Boreal Collection"))
    skinList.push(new Skin("Red Tide","Pistol","P250","Mil-Spec","The Radiant Collection"))
    ...
    skinList.push(new Skin("Lime Hex","Mid-Tier","MP5-SD","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Runoff","Mid-Tier","Sawed-Off","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("The Battlestar","Rifle","M4A4","Covert","Revolver Case"))
    skinList.push(new Skin("MAGnitude","Mid-Tier","MAG-7","Mil-Spec","Sealed Genesis Terminal"))
    skinList.push(new Skin("Robin's Egg","Rifle","Galil AR","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Mauve Aside","Pistol","R8 Revolver","Consumer Grade","The Harlequin Collection"))
    skinList.push(new Skin("Blue Blast","Pistol","Tec-9","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Acid Dart","Rifle","Galil AR","Industrial Grade","The Boreal Collection"))
    skinList.push(new Skin("Grip Tape","Pistol","P2000","Mil-Spec","The Achroma Collection"))
    skinList.push(new Skin("BorDeux","Pistol","Dual Berettas","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Thermal Currents","Mid-Tier","PP-Bizon","Consumer Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Ocean Topo","Pistol","Glock-18","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Ice Coaled","Rifle","AWP","Classified","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Rose Hex","Rifle","M4A1-S","Mil-Spec","The Radiant Collection"))
    ...
    skinList.push(new Skin("Jungle Tiger","Rifle","M4A4","Industrial Grade","The Dust Collection"))
    ...
    skinList.push(new Skin("Continuum","Mid-Tier","UMP-45","Restricted","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Bad Trip","Rifle","FAMAS","Covert","Fever Case"))
    ...
    skinList.push(new Skin("Grey Smoke","Rifle","SSG 08","Consumer Grade","The Ascent Collection"))
    skinList.push(new Skin("Red Tire","Pistol","Glock-18","Industrial Grade","The 2021 Vertigo Collection"))
    skinList.push(new Skin("The Emperor","Rifle","M4A4","Covert","Clutch Case"))
    ...
    skinList.push(new Skin("Constructivist","Pistol","P250","Industrial Grade","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Hellfire","Rifle","M4A4","Classified","Gamma Case"))
    ...
    skinList.push(new Skin("Currents","Mid-Tier","Nova","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Royal Paladin","Rifle","M4A4","Covert","eSports 2014 Summer Case"))
    ...
    skinList.push(new Skin("Modern Hunter","Rifle","M4A4","Restricted","Fever Case"))
    ...
    skinList.push(new Skin("Latte Rush","Mid-Tier","MP9","Classified","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Urban DDPAT","Rifle","M4A4","Industrial Grade","The Inferno Collection"))
    ...
    skinList.push(new Skin("PC-GRN","Pistol","USP-S","Mil-Spec","Fever Case"))
    ...
    skinList.push(new Skin("Run Run Run","Mid-Tier","XM1014","Mil-Spec","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("龍王 (Dragon King)","Rifle","M4A4","Classified","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Banana Leaf","Pistol","Tec-9","Industrial Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Tropical Breeze","Pistol","USP-S","Mil-Spec","The Boreal Collection"))
    ...
    skinList.push(new Skin("Swamp DDPAT","Pistol","Zeus x27","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Raw Ceramic","Pistol","Tec-9","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Zirka","Rifle","M4A4","Restricted","The Graphic Design Collection"))
    ...
    skinList.push(new Skin("Liquidation","Rifle","M4A1-S","Restricted","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Control","Rifle","Galil AR","Restricted","Fever Case"))
    ...
    skinList.push(new Skin("Memorial","Rifle","SSG 08","Mil-Spec","Fever Case"))
    ...
    skinList.push(new Skin("Blue Tac","Mid-Tier","P90","Consumer Grade","The Ascent Collection"))
    skinList.push(new Skin("Orange DDPAT","Rifle","Galil AR","Restricted","eSports 2013 Case"))
    skinList.push(new Skin("Sleet","Mid-Tier","M249","Consumer Grade Machine","The Achroma Collection"))
    skinList.push(new Skin("Picnic","Mid-Tier","MP5-SD","Industrial Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Dark Blossom","Rifle","M4A4","Industrial Grade","The 2018 Nuke Collection"))
    ...
    skinList.push(new Skin("Short Ochre","Rifle","SCAR-20","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Commando Company","Rifle","AUG","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Dizzy","Mid-Tier","MP9","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Warm Blooded","Mid-Tier","UMP-45","Mil-Spec","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Grey Ghost","Rifle","FAMAS","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Nexus","Mid-Tier","MP9","Mil-Spec","Fever Case"))
    ...
    skinList.push(new Skin("Blush Pour","Rifle","SSG 08","Mil-Spec","The Radiant Collection"))
    skinList.push(new Skin("Grip","Pistol","R8 Revolver","Mil-Spec","Clutch Case"))
    skinList.push(new Skin("LongDog","Rifle","AWP","Covert","The Train 2025 Collection"))
    skinList.push(new Skin("Whiteout","Pistol","Tec-9","Restricted","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Hellish","Rifle","M4A4","Classified","The Gods and Monsters Collection"))
    ...
    skinList.push(new Skin("Party Animal","Rifle","M4A1-S","Classified","The Harlequin Collection"))
    skinList.push(new Skin("Death Rattle","Pistol","Glock-18","Industrial Grade","The Bank Collection"))
    skinList.push(new Skin("Asiimov","Rifle","M4A4","Covert","eSports 2013 Winter Case"))
    ...
    skinList.push(new Skin("Printstream","Rifle","AWP","Covert","Fever Case"))
    skinList.push(new Skin("Plum Netting","Pistol","P250","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Polished Malachite","Pistol","Dual Berettas","Industrial Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Glitched Paint","Rifle","M4A1-S","Restricted","The Radiant Collection"))
    ...
    skinList.push(new Skin("Bullfrog","Pistol","P250","Mil-Spec","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Tosai","Pistol","Zeus x27","Restricted","Fever Case"))
    skinList.push(new Skin("Derailment","Mid-Tier","MAC-10","Restricted","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Snow Splash","Mid-Tier","MP5-SD","Industrial Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("X-Ray","Rifle","M4A4","Covert","Anubis Collection Package"))
    ...
    skinList.push(new Skin("Copper Fiber","Pistol","CZ75-Auto","Industrial Grade","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Mirror Mosaic","Pistol","Glock-18","Classified","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Wood Block Camo","Mid-Tier","PP-Bizon","Consumer Grade","The Radiant Collection"))
    skinList.push(new Skin("Autumn Thicket","Pistol","Five-SeveN","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Green Apple","Rifle","Galil AR","Industrial Grade","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Aeolian Dark","Rifle","M4A4","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Green Cell","Rifle","G3SG1","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Daybreak","Rifle","M4A4","Restricted","The Militia Collection"))
    ...
    skinList.push(new Skin("Red Jasper","Rifle","G3SG1","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Global Offensive","Rifle","M4A4","Mil-Spec","The 2018 Inferno Collection"))
    ...
    skinList.push(new Skin("O-Ranger","Rifle","Galil AR","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Sky Blue","Pistol","Five-SeveN","Industrial Grade","The Ascent Collection"))
    skinList.push(new Skin("Turquoise Pour","Mid-Tier","Nova","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Focus","Mid-Tier","MP5-SD","Mil-Spec","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Sedimentary","Pistol","P250","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Safari Print","Rifle","SG 553","Consumer Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Desert-Strike","Rifle","M4A4","Covert","Winter Offensive Weapon Case"))
    ...
    skinList.push(new Skin("Bullet Rain","Rifle","M4A4","Covert","Huntsman Weapon Case"))
    skinList.push(new Skin("Poseidon","Rifle","M4A4","Classified","The Boreal Collection"))
    skinList.push(new Skin("Afterimage","Rifle","FAMAS","Classified","eSports 2013 Winter Case"))
    skinList.push(new Skin("Magnesium","Rifle","M4A4","Mil-Spec","eSports 2013 Case"))
    skinList.push(new Skin("Sand Dune","Rifle","SSG 08","Consumer Grade","The Baggage Collection"))
    skinList.push(new Skin("Grey Smoke","Rifle","Galil AR","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Garter-9","Pistol","Tec-9","Industrial Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Turbine","Rifle","M4A4","Restricted","Kilowatt Case"))
    ...
    skinList.push(new Skin("Creep","Rifle","AUG","Mil-Spec","The Achroma Collection"))
    ...
    skinList.push(new Skin("Faded Zebra","Rifle","M4A4","Mil-Spec","The Control Collection"))
    ...
    skinList.push(new Skin("Ocular","Mid-Tier","Nova","Restricted","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Mint Fan","Pistol","Desert Eagle","Mil-Spec","The Ascent Collection"))
    ...
    skinList.push(new Skin("Multi-Terrain","Mid-Tier","MP9","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("27","Pistol","USP-S","Mil-Spec","Gallery Case"))
    ...
    skinList.push(new Skin("Green Ceramic","Rifle","SSG 08","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Neo-Noir","Mid-Tier","UMP-45","Classified","Gallery Case"))
    skinList.push(new Skin("Short Ochre","Mid-Tier","MP7","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Coral Bloom","Pistol","Glock-18","Mil-Spec","The Radiant Collection"))
    skinList.push(new Skin("Submerged","Mid-Tier","M249","Consumer Grade Machine","Anubis Collection Package"))
    skinList.push(new Skin("Charged Up","Pistol","Zeus x27","Restricted","The Train 2025 Collection"))
    skinList.push(new Skin("Sage Camo","Mid-Tier","M249","Consumer Grade Machine","The Boreal Collection"))
    skinList.push(new Skin("Searing Rage","Rifle","AK-47","Classified","Fever Case"))
    ...
    skinList.push(new Skin("Griffin","Rifle","M4A4","Restricted","Operation Bravo Case"))
    skinList.push(new Skin("Stone Cold","Rifle","Galil AR","Restricted","Shadow Case"))
    skinList.push(new Skin("Temukau","Rifle","M4A4","Covert","Snakebite Case"))
    skinList.push(new Skin("Shinobu","Pistol","Glock-18","Classified","Fever Case"))
    ...
    skinList.push(new Skin("Raw Ceramic","Mid-Tier","Negev","Consumer Grade Machine","The Boreal Collection"))
    ...
    skinList.push(new Skin("Late Night Transit","Mid-Tier","UMP-45","Mil-Spec","The Train 2025 Collection"))
    skinList.push(new Skin("Night Camo","Rifle","SG 553","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Green Line","Pistol","Glock-18","Mil-Spec","The Train 2025 Collection"))
    skinList.push(new Skin("Gold Leaf","Mid-Tier","MP5-SD","Mil-Spec","The Boreal Collection"))
    skinList.push(new Skin("Buddy","Pistol","Five-SeveN","Restricted","CS20 Case"))
    skinList.push(new Skin("Canvas Cloud","Mid-Tier","XM1014","Consumer Grade","The Radiant Collection"))
    skinList.push(new Skin("Glockingbird","Pistol","Glock-18","Restricted","The Boreal Collection"))
    ...
    skinList.push(new Skin("Wave Breaker","Mid-Tier","P90","Restricted","Fever Case"))
    ...
    skinList.push(new Skin("Reef Grief","Mid-Tier","P90","Mil-Spec","The Ascent Collection"))
    skinList.push(new Skin("Neon Kimono","Pistol","Five-SeveN","Restricted","The Rising Sun Collection"))
    skinList.push(new Skin("Buff Blue","Mid-Tier","MP9","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Mustard Gas","Mid-Tier","P90","Industrial Grade","The Boreal Collection"))
    skinList.push(new Skin("Exothermic","Rifle","AWP","Restricted","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Solitude","Mid-Tier","XM1014","Restricted","Limited Edition Item 2025"))
    ...
    skinList.push(new Skin("The Oligarch","Rifle","AK-47","Covert","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Broken Record","Mid-Tier","MP9","Mil-Spec","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("XoooM","Mid-Tier","XM1014","Industrial Grade","The Harlequin Collection"))
    skinList.push(new Skin("Caged","Rifle","SCAR-20","Mil-Spec","Sealed Genesis Terminal"))
    skinList.push(new Skin("Carbon Fiber","Mid-Tier","PP-Bizon","Industrial Grade","The Vertigo Collection"))
    skinList.push(new Skin("In Living Color","Rifle","M4A4","Covert","Prisma Case"))
    skinList.push(new Skin("Pink Pearl","Pistol","CZ75-Auto","Consumer Grade","The Radiant Collection"))
    skinList.push(new Skin("Steel Sentinel","Rifle","AUG","Industrial Grade","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Naval Shred Camo","Rifle","M4A4","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Arsenic Spill","Rifle","AWP","Mil-Spec","The Radiant Collection"))
    ...
    skinList.push(new Skin("Sans Comic","Rifle","SSG 08","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Silver Pour","Pistol","Dual Berettas","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Sour Grapes","Mid-Tier","Negev","Industrial Grade Machine","The Ascent Collection"))
    skinList.push(new Skin("Chrome Cannon","Rifle","AWP","Covert","Kilowatt Case"))
    skinList.push(new Skin("Sleeping Potion","Pistol","USP-S","Restricted","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Dark Chamber","Pistol","R8 Revolver","Industrial Grade","The Achroma Collection"))
    skinList.push(new Skin("Snow Splash","Mid-Tier","MAC-10","Industrial Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("Fraise Crane","Pistol","Five-SeveN","Mil-Spec","The Harlequin Collection"))
    skinList.push(new Skin("Contrast Spray","Mid-Tier","M249","Consumer Grade Machine","The Overpass Collection"))
    skinList.push(new Skin("Desolate Space","Rifle","M4A4","Classified","Chroma Case"))
    ...
    skinList.push(new Skin("Copperflage","Mid-Tier","XM1014","Mil-Spec","The Boreal Collection"))
    ...
    skinList.push(new Skin("Palm","Rifle","FAMAS","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Green Swirl","Mid-Tier","UMP-45","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Mulberry","Pistol","Desert Eagle","Restricted","The Radiant Collection"))
    ...
    skinList.push(new Skin("Aeolian Light","Mid-Tier","P90","Mil-Spec","The Achroma Collection"))
    ...
    skinList.push(new Skin("Electric Blue","Pistol","Zeus x27","Industrial Grade","The Ascent Collection"))
    skinList.push(new Skin("Oceanic","Pistol","P2000","Mil-Spec","Chroma 3 Case"))
    skinList.push(new Skin("Stratosphere","Rifle","M4A1-S","Classified","The Ascent Collection"))
    skinList.push(new Skin("Warhawk","Pistol","Glock-18","Mil-Spec","Horizon Case"))
    skinList.push(new Skin("Steel Work","Rifle","M4A4","Industrial Grade","The St. Marc Collection"))
    ...
    skinList.push(new Skin("Choppa","Rifle","M4A4","Mil-Spec","Recoil Case"))
    skinList.push(new Skin("Red DDPAT","Rifle","M4A4","Restricted","The Rising Sun Collection"))
    ...
    skinList.push(new Skin("Copper Oxide","Pistol","P250","Consumer Grade","The Boreal Collection"))
    skinList.push(new Skin("Motorized","Mid-Tier","UMP-45","Mil-Spec","Kilowatt Case"))
    skinList.push(new Skin("Shredded","Mid-Tier","MP9","Mil-Spec","The Radiant Collection"))
    ...
    skinList.push(new Skin("Poplar Thicket","Mid-Tier","MAC-10","Mil-Spec","The Boreal Collection"))
    skinList.push(new Skin("Bronzer","Mid-Tier","MAC-10","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Citric Acid","Pistol","Tec-9","Industrial Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Rain Station","Mid-Tier","Nova","Industrial Grade","The Train 2025 Collection"))
    skinList.push(new Skin("Serpent Strike","Pistol","Desert Eagle","Restricted","Fever Case"))
    skinList.push(new Skin("Bizoom","Mid-Tier","PP-Bizon","Consumer Grade","The Achroma Collection"))
    ...
    skinList.push(new Skin("K.O. Factory","Mid-Tier","UMP-45","Classified","Fever Case"))
    skinList.push(new Skin("Cobalt Grip","Pistol","R8 Revolver","Consumer Grade","The Ascent Collection"))
    skinList.push(new Skin("The Coalition","Rifle","M4A4","Covert","Operation Broken Fang Case"))
    ...
    skinList.push(new Skin("Etch Lord","Rifle","M4A4","Restricted","Operation Riptide Case"))
    skinList.push(new Skin("Malachite","Mid-Tier","MAC-10","Restricted","Chroma Case"))
    skinList.push(new Skin("Straight Dimes","Mid-Tier","P90","Industrial Grade","The Train 2025 Collection"))
    ...
    skinList.push(new Skin("Trigger Discipline","Rifle","AUG","Mil-Spec","Sealed Genesis Terminal"))
    ...
    skinList.push(new Skin("Storm Camo","Mid-Tier","MAC-10","Consumer Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Tornado","Rifle","M4A4","Industrial Grade","The Aztec Collection"))
    ...
    skinList.push(new Skin("Rose Nacre","Pistol","Dual Berettas","Industrial Grade","The Ascent Collection"))
    ...
    skinList.push(new Skin("Pine","Mid-Tier","MP9","Consumer Grade","The Boreal Collection"))
    ...
    skinList.push(new Skin("Radiation Hazard","Rifle","M4A4","Mil-Spec","The Achroma Collection"))
    ...
    skinList.push(new Skin("Desert Halftone","Mid-Tier","P90","Consumer Grade","The Radiant Collection"))
    ...
    skinList.push(new Skin("Yeti Camo","Rifle","FAMAS","Mil-Spec","The Ascent Collection"))
    ...
    skinList.push(new Skin("Rising Sun","Mid-Tier","Nova","Restricted","Fever Case"))
    skinList.push(new Skin("System Lock","Mid-Tier","M249","Mil-Spec Machine","Chroma Case"))
    skinList.push(new Skin("Evil Daimyo","Rifle","M4A4","Restricted","Operation Vanguard Weapon Case"))
    ...
    skinList.push(new Skin("Mainframe","Rifle","M4A4","Industrial Grade","The Train Collection"))
    ...
    skinList.push(new Skin("Heat Treated","Pistol","Desert Eagle","Classified","Limited Edition Item 2024"))
    ...
    skinList.push(new Skin("Bee-Tron","Mid-Tier","MP9","Consumer Grade","The Harlequin Collection"))
    skinList.push(new Skin("Imminent Danger","Rifle","M4A1-S","Covert","The 2021 Vertigo Collection"))
    skinList.push(new Skin("Poly Mag","Rifle","M4A4","Mil-Spec","Danger Zone Case"))
    ...
    skinList.push(new Skin("Calligrafaux","Rifle","SSG 08","Industrial Grade","The Harlequin Collection"))
    ...
    skinList.push(new Skin("Polysoup","Rifle","M4A4","Restricted","The 2021 Dust 2 Collection"))
    ...
    skinList.push(new Skin("Bleeding Edge","Pistol","USP-S","Restricted","The Radiant Collection"))
