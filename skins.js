...
function createSkins(input){
    ...
    skinList.push(new Skin("Solitude","Mid-Tier","XM1014","Restricted","Limited Edition Item"))
    ...
    skinList.push(new Skin("Solitude","Rifle","M4A1-S","Classified","Limited Edition Item"))
    ...
    skinList.push(new Skin("The Coalition","Rifle","M4A4","Covert","The Train 2025 Collection"))
    skinList.push(new Skin("Hellish","Rifle","M4A4","Classified","Operation Broken Fang Case"))
    ...
    skinList.push(new Skin("龍王 (Dragon King)","Rifle","M4A4","Classified","The Gods and Monsters Collection"))
    ...
    skinList.push(new Skin("Radiation Hazard","Rifle","M4A4","Mil-Spec","The Ascent Collection"))
